...
<form action="{{ route('admin.characters.update', $character->id) }}" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Lorem ipsum" aria-describedby="titleHelper" value="{{ $character->title }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="cover" id="cover" class="form-control @error('cover') is-invalid @enderror" placeholder="https://yourimage_here.jpg" aria-describedby="coverHelper" value="{{ $character->cover }}">
